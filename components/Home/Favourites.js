  ...
  return (
    <div className="p-4 w-[100%] lg:w-[90%] xl:w-[75%] m-auto sm:my-12">
      <div
        ...
        style={{ direction: "rtl" }}
      >
        <p className="text-black text-[24px] font-bold">کتاب‌های محبوب</p>
        <div className="flex items-center gap-2">
          <p className="text-[#354259] text-[20px] font-fat">همه کتاب‌ها</p>
      ...
      <p className="text-black text-[16px] font-light text-right my-5">
